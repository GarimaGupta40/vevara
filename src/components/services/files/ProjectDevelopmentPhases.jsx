...
/* ------------------------------------------------------------------ */
/* Phase data                                                          */
/*  numberIn: "text" | "icon" | "both"  → where the number is printed  */
/*  (02, 03, 04 and 07 print it twice in the reference design)         */
/* ------------------------------------------------------------------ */
...
const PHASES = [
  {
    ...
    box: { left: 265, top: 82, width: 166, height: 44 },
    radius: "22px",
    from: "#1f47a4",
    to: "#132b70",
  ...
  },
  {
    ...
    box: { left: 418, top: 122, width: 158, height: 64 },
    radius: LEAF,
    from: "#3d9dff",
    to: "#1f74e8",
  ...
  },
  {
    ...
    box: { left: 468, top: 200, width: 152, height: 68 },
    radius: LEAF,
    from: "#1fc8b3",
    to: "#0d9c8f",
  ...
  },
  {
    ...
    box: { left: 455, top: 287, width: 160, height: 76 },
    radius: LEAF,
    from: "#ffae40",
    to: "#fa7418",
  ...
  },
  {
    ...
    box: { left: 262, top: 380, width: 174, height: 52 },
    radius: LEAF,
    from: "#f44d4d",
    to: "#dc2430",
  ...
  },
  {
    ...
    box: { left: 97, top: 338, width: 166, height: 60 },
    radius: LEAF,
    from: "#8c5cf7",
    to: "#6b3fd8",
  ...
  },
  {
    ...
    box: { left: 70, top: 258, width: 160, height: 64 },
    radius: LEAF,
    from: "#5649dc",
    to: "#3a2fb6",
  ...
  },
  {
    ...
    box: { left: 78, top: 190, width: 154, height: 60 },
    radius: LEAF,
    from: "#f2489f",
    to: "#c72688",
  ...
  },
  {
    ...
    box: { left: 123, top: 122, width: 152, height: 58 },
    radius: LEAF,
    from: "#7b8ab9",
    to: "#56648f",
...
const ARCS = [
  { p0: [200, 140], c: [196, 104], p1: [266, 96] },
  { p0: [430, 96], c: [466, 92], p1: [478, 134] },
  { p0: [486, 356], c: [478, 392], p1: [432, 398] },
  { p0: [266, 414], c: [216, 424], p1: [204, 372] },
];

const arcGeometry = ({ p0, c, p1 }) => {
  const mid = [
...
/* Pass your own image with the `boxImage` prop to replace it.         */
/* ------------------------------------------------------------------ */
...
export default function ProjectDevelopmentPhases({ boxImage, className = "" }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <span className="pdp__eyebrow-line" />
        <p className="pdp__eyebrow">Our Approach</p>
        <h2 id="pdp-title" className="pdp__title">
          Project Development Phases
        </h2>
        <p className="pdp__subtitle">
          A structured and collaborative approach to deliver the right packaging
